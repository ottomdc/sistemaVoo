...
if(!empty($_SESSION['id'])){
    if($btnCad){
        ...
        $pouso = $_POST['pouso'];
        $corte = $_POST['corte'];
        $tacInicial = $_POST['tacInicial'];
        $tacFinal = $_POST['tacFinal'];
        $tempoVoo = $_POST['tempoVoo'];
        $combDecolagem = $_POST['combDecolagem'];
        $combPouso = $_POST['combPouso'];
        $combUtilizado = $_POST['combUtilizado'];
        $autonomia = $_POST['autonomia'];
        $pesoCombustivel = $_POST['pesoComb'];
        $consumoReal = $_POST['consReal'];
        $n1 = $_POST['n1'];
        $fuelPress = $_POST['fuelPress'];
        $fuelFlow = $_POST['fuelFlow'];
        $vi = $_POST['vi'];
        $egt = $_POST['egt'];
        $oilPress = $_POST['oilPress'];
        $va = $_POST['va'];
        $hp = $_POST['hp'];
        $oilTemp = $_POST['oilTemp'];
        $vs = $_POST['vs'];
        $torque = $_POST['torque'];
        $horarioParametro = $_POST['horarioParametros'];
        $oat = $_POST['oat'];
        $pesoTotal = $_POST['pesoTotal'];
        $idPax1 = $_POST['nomePax1'];
        $idPax2 = $_POST['nomePax2'];
        $idPax3 = $_POST['nomePax3'];
        $idPax4 = $_POST['nomePax4'];
        $idPax5 = $_POST['nomePax5'];
        $idPax6 = $_POST['nomePax6'];
        $idPax7 = $_POST['nomePax7'];



        $tempoPousoDecolagem = calculaTempo($decolagem,$pouso);
        $tempoCorteAcionamento = calculaTempo($acionamento,$corte);
        $tempoTaxi = calculaTempo($acionamento,$decolagem);
        $kmVoado = ((int)$distancia*1.852);




        $sql = "INSERT INTO planejamento_voo (data_voo, aeronave, piloto, copiloto, origem, destino, distancia, nivel, rumo, pob, pax, alternativa, acionamento, decolagem, tacInicial, pouso, corte, tacFinal, tempoVoo, combDecolagem, combPouso, comUtilizado, autonomia, pesoCombustivel, consumoReal, vi, va, vs, oat, n1, egt, hp, torque, fuelFlow, fuelPress, oilPress, oilTemp, horarioParametros, pesoTotal, pax1, pax2, pax3, pax4, pax5, pax6, pax7,tempoAcionamCorte,tempoPousoDecolagem,tempoTaxi,kmVoado) 
  VALUES ('$data_voo','$aeronave', '$piloto', '$copiloto', '$origem', '$destino', '$distancia', '$nivel', '$rumo', '$pob',
          '$pax', '$alternativa', '$acionamento', '$decolagem', '$tacInicial', '$pouso', '$corte', '$tacFinal', '$tempoVoo', '$combDecolagem', '$combPouso', '$combUtilizado', '$autonomia', '$pesoCombustivel', '$consumoReal', '$vi', '$va', '$vs', '$oat', '$n1', '$egt', '$hp', '$torque', '$fuelFlow', '$fuelPress', '$oilPress','$oilTemp', '$horarioParametro','$pesoTotal', '$idPax1', '$idPax2', '$idPax3', '$idPax4', '$idPax5', '$idPax6', '$idPax7', '$tempoCorteAcionamento', '$tempoPousoDecolagem', '$tempoTaxi', '$kmVoado')";
        ...
        if($resultado){
            ...
            echo "<script>alert('Erro ao cadastrar o planejamento')</script>";
                    ...
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date"  placeholder="dd/mm/aaaa" class="form-control" id="data" name="data">
                                </td>
                                <td>
                                ...
                                <td>
                                    <select class="custom-select"name="piloto" id="piloto">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="custom-select" name="copiloto" id="copiloto">
                            ...
                            <tr>
                                <td>
                                    <label for="distancia" class="form-control">DISTÂNCIA:</label>
                                </td>
                                <td>
                                    <input class="form-control" type="text" placeholder="Distância em MN"  id="distancia" name="distancia">
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="time"  placeholder="hora utc" class="form-control" id="acionamento" name="acionamento">
                                </td>
                                <td>
                                    <label for="decolagem" class="form-control">DECOLAGEM:</label>
                                </td>
                                <td>
                                    <input class="form-control" type="time" placeholder="hora utc" id="decolagem" name="decolagem">
                                </td>
                                <td>
                                    <label for="pouso" class="form-control">POUSO:</label>
                                </td>
                                <td>
                                    <input class="form-control" type="time" placeholder="hora utc" id="pouso" name="pouso">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="time"  placeholder="hora utc" class="form-control" id="corte" name="corte">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="etaTerminal" class="form-control">ETA TMA:</label>
                                </td>
                                <td>
                                    <input type="text"  placeholder="estimado terminal" class="form-control" id="etaTerminal" name="etaTerminal">
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="time" id="horario" name="horarioParametros">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control text-center" id="pesoTotal" name="pesoTotal">
                                </td>
                                <td>
